...
//  SocialMediaApp
//
//  Created by Дмитрий Папушин on 21/04/2019.
...
class Notification {
    // protocol Printable is contains in protocol file
    enum NotificationType: Int, Printable {
        // all of that I've typed out down below are conformed to types which was created in database
        case Like
        case Comment
        case Follow
        case CommentMention
