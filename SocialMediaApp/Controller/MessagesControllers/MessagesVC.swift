...
//  SocialMediaApp
//
//  Created by Дмитрий Папушин on 09/05/2019.
...
class MessagesVC: UITableViewController {
    ...
    @objc func handleNewMessage() {
        ...
        let navifationController =  UINavigationController(rootViewController: newMessageController)
        self.present(navifationController, animated: true, completion: nil)
    }
