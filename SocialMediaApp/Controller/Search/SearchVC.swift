...
class SearchVC: UITableViewController, UISearchBarDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    //MARK: - Properties
    // all user that I will use I just going to append into this array
    var users = [User]()
    ...
    override func viewDidLoad() {
        ...
        //fetchUsers() get to searchbar text eddeting begin
    ...
    // hadle the cross to the user profile when clicking in search VC
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // create an instance of user profile vc
        let userProfileVC = UserProfileVC(collectionViewLayout: UICollectionViewFlowLayout())
        
        // passes from search VC to User Profile VC
    ...
    func fetchPosts() {
        ...
        if currentKey == nil {
            ...
            USER_POSTS_REF.queryOrderedByKey().queryEnding(atValue: self.currentKey).queryLimited(toLast: 10).observeSingleEvent(of: .value) { (snapshot) in
