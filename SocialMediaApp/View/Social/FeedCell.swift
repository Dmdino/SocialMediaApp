...
class FeedCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        usernameButton.anchor(top: nil, left: profileImageView.rightAnchor, bottom: nil, right: nil, paddingTop: 8, paddingLeft: 8, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
